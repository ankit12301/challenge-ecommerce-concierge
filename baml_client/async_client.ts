...
export type RecursivePartialNull<T> = MovedRecursivePartialNull<T>
    ...
    env?: Record<string, string | undefined>
      tags?: Record<string, string>
        ...
        user_request: string,conversation_history: string,
        __baml_options__?: BamlCallOptions<never>
          ...
          if (options.onTick) {
          const stream = this.stream.DecideNextAction(
          ...
          const env: Record<string, string> = Object.fromEntries(
            ...
            return raw.parsed(false) as types.AgentResponse
            } catch (error) {
        ...
        __baml_options__?: BamlCallOptions<never>
          ...
          // Check if onTick is provided - route through streaming if so
          if (options.onTick) {
          const stream = this.stream.GenerateSong(
          topic,
          __baml_options__
          );
          ...
          const env: Record<string, string> = Object.fromEntries(
            ...
            return raw.parsed(false) as types.Song
            } catch (error) {
            throw toBamlError(error);
            }
            }
            ...
            topic: string,
            __baml_options__?: BamlCallOptions<never>
            ): BamlStream<partial_types.Song, types.Song>
              {
              try {
              const options = { ...this.bamlOptions, ...(__baml_options__ || {}) }
              const signal = options.signal;
              ...
              console.error("Error in onTick callback for GenerateSong", error);
              }
              }
              };
              }
              ...
              const env: Record<string, string> = Object.fromEntries(
                ...
                return new BamlStream<partial_types.Song, types.Song>(
                  raw,
                  (a): partial_types.Song => a,
                  (a): types.Song => a,
                  this.ctxManager.cloneContext(),
                  options.signal,
                  )
